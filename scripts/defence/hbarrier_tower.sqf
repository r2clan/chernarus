...
// Written by: Riddlez @ www.r2clan.net
    ...
    _object = "Land_HBarrierTower_F" createVehicle (position player);
    ...
    cutText [format["You've used your materials to make a HBarrier Tower."], "PLAIN DOWN"];
    sleep 3; 

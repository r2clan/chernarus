...
else
{
	...
	if !(isNil "_est_calculateur") then
	{
		...
		[_objet] execVM "scripts\R3F_ARTY_AND_LOG\R3F_ARTY\poste_commandement\deplacer_calculateur.sqf";
	}
	else
	{
		...
		else
		{
			...
			_action_menu_release_relative = player addAction [("<img image=""icons\r3f_release.paa""/> <t color=""#06ef00"">" + STR_R3F_LOG_action_relacher_objet + "</t>"), "scripts\R3F_ARTY_AND_LOG\R3F_LOG\objet_deplacable\relacher.sqf", false, 5, true, true];
			_action_menu_release_horizontal = player addAction [("<img image=""icons\r3f_releaseh.paa""/> <t color=""#06ef00"">" + STR_RELEASE_HORIZONTAL + "</t>"), "scripts\R3F_ARTY_AND_LOG\R3F_LOG\objet_deplacable\relacher.sqf", true, 5, true, true];
			_action_menu_45 = player addAction [("<img image=""icons\r3f_rotate.paa""/> <t color=""#06ef00"">Rotate object 45°</t>"), "scripts\R3F_ARTY_AND_LOG\R3F_LOG\objet_deplacable\rotate.sqf", 45, 5, true, true];
			//_action_menu_90 = player addAction [("<img image='client\ui\ui_arrow_combo_ca.paa' width='32' height='32'/> <t color=""#dddd00"">Rotate object 90°</t>"), "scripts\R3F_ARTY_AND_LOG\R3F_LOG\objet_deplacable\rotate.sqf", 90, 5, true, true];
			//_action_menu_180 = player addAction [("<img image='client\ui\ui_arrow_combo_ca.paa' width='32' height='32'/> <t color=""#dddd00"">Rotate object 180°</t>"), "scripts\R3F_ARTY_AND_LOG\R3F_LOG\objet_deplacable\rotate.sqf", 180, 5, true, true];

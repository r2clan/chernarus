...
[] spawn
{
	...
	call compile preprocessFile format ["scripts\R3F_ARTY_AND_LOG\%1_strings_lang.sqf", R3F_ARTY_AND_LOG_CFG_langage];
	...
	if (isDedicated) then
	{
		...
		//execVM "scripts\R3F_ARTY_AND_LOG\surveiller_nouveaux_objets_dedie.sqf";
	}
	else
	{
		execVM "scripts\R3F_ARTY_AND_LOG\surveiller_nouveaux_objets.sqf";
